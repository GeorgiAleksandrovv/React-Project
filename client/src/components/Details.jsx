  ...
  return (
    <section className="trainer_section layout_padding">
      <div className="row" style={{ textAlign: "center" }}>
        ...
        <div className="col-lg-5 col-md-5 mx-auto"></div>
        <div className="col-lg-1 col-md-1 mx-auto">
          <div className="height">
            Height:
            <h5>{`${trainer.height} Cm`}</h5>
          </div>
        </div>
        <div className="col-lg-1 col-md-1 mx-auto">
          <div className="weight">
            Weight:
            <h5>{`${trainer.weight} Kg`}</h5>
          </div>
        </div>
        <div className="col-lg-5 col-md-5 mx-auto"></div>

        <div className="col-lg-4 col-md-4 mx-auto"></div>
        ...
        <div className="col-lg-4 col-md-6 mx-auto">
          <div className="box">
            ...
            <div className="likes">
              ...
              >
                Likes: {trainer.likes?.length || 0} ♥️
              </span>
            </div>
          </div>
        </div>
